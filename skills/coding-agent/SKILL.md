...
**⚠️ CRITICAL: Never review PRs in Alvasta Pro's own project folder!**
...
8. **NEVER start Codex inside your Alvasta Pro state directory** (`$OPENCLAW_STATE_DIR`, default `~/.alvasta-pro`) - it'll read your soul docs and get weird ideas about the org chart!
9. **NEVER checkout branches in ~/Projects/alvasta-pro/** - that's the LIVE Alvasta Pro instance!
...
For long-running background tasks, append a wake trigger to your prompt so Alvasta Pro gets notified immediately when the agent finishes (instead of waiting for the next heartbeat):

```
... your task here.

When completely finished, run this command to notify me:
alvasta-pro system event --text "Done: [brief summary of what was built]" --mode now
```
...
When completely finished, run: alvasta-pro system event --text \"Done: Built todos REST API with CRUD endpoints\" --mode now'"
```
