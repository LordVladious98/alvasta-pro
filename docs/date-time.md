...
Alvasta Pro defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, Alvasta Pro inspects the OS preference (macOS/Windows)
