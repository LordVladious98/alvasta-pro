...
summary: Machine-checked security models for Alvasta Pro’s highest-risk paths.
read_when:
...
This page tracks Alvasta Pro’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Alvasta Pro enforces its
...
**What this is not (yet):** a proof that “Alvasta Pro is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/alvasta-pro-formal-models](https://github.com/vignesh07/alvasta-pro-formal-models).
...
```bash
git clone https://github.com/vignesh07/alvasta-pro-formal-models
cd alvasta-pro-formal-models
