...
It is modeled after Claude Code's `/btw` behavior, but adapted to Alvasta Pro's
...
If the main run is currently active, Alvasta Pro snapshots the current message
