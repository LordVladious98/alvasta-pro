...
summary: "Testing utilities and patterns for Alvasta Pro plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Alvasta Pro
plugins.
...
**Import:** `alvasta-pro/plugin-sdk/testing`
...
} from "alvasta-pro/plugin-sdk/testing";
```
...
import { installCommonResolveTargetErrorCases } from "alvasta-pro/plugin-sdk/testing";
...
import type { PluginRuntime } from "alvasta-pro/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `alvasta-pro/plugin-sdk` root barrel is rejected
...
Alvasta Pro uses Vitest with V8 coverage thresholds. For plugin tests:
