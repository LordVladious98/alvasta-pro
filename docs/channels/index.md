---
summary: "Messaging platforms Alvasta Pro can connect to"
read_when:
  - You want to choose a chat channel for Alvasta Pro
...
Alvasta Pro can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- [WeChat](https://www.npmjs.com/package/@tencent-weixin/alvasta-pro-weixin) — Tencent iLink Bot plugin via QR login; private chats only.
...
- Channels can run simultaneously; configure multiple and Alvasta Pro will route per chat.
