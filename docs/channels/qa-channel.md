---
title: "QA Channel"
summary: "Synthetic Slack-class channel plugin for deterministic Alvasta Pro QA scenarios"
read_when:
...
`qa-channel` is a bundled synthetic message transport for automated Alvasta Pro QA.
...
```json
{
  "channels": {
    "qa-channel": {
      ...
      "botUserId": "alvasta-pro",
      "botDisplayName": "Alvasta Pro QA",
      "allowFrom": ["*"],
      "pollTimeoutMs": 1000
    }
  }
...
- Alvasta Pro-native orchestration later
