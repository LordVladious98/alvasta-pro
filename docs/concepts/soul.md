---
summary: "Use SOUL.md to give your Alvasta Pro agent an actual voice instead of generic assistant sludge"
read_when:
...
Alvasta Pro injects it on normal sessions, so it has real weight. If your agent
...
For Alvasta Pro, `SOUL.md` is that layer.
...
Path fixed for Alvasta Pro workspaces: use `SOUL.md`, not `http://SOUL.md`.
