...
Alvasta Pro also runs a separate idempotent cleanup for older legacy sessions that
...
Alvasta Pro auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Alvasta Pro does not override them.
