---
summary: "Use Qianfan's unified API to access many models in Alvasta Pro"
read_when:
...
3. Alvasta Pro installed on your system
...
4. Copy the API key for use with Alvasta Pro

## CLI setup

```bash
alvasta-pro onboard --auth-choice qianfan-api-key
```
...
- [Alvasta Pro Configuration](/gateway/configuration)
