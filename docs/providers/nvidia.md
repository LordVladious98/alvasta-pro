---
summary: "Use NVIDIA's OpenAI-compatible API in Alvasta Pro"
read_when:
  - You want to use NVIDIA models in Alvasta Pro
...
alvasta-pro onboard --auth-choice skip
alvasta-pro models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
