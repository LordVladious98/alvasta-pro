...
read_when:
  - You want to use Arcee AI with Alvasta Pro
...
alvasta-pro onboard --auth-choice arceeai-api-key

# Via OpenRouter
alvasta-pro onboard --auth-choice arceeai-openrouter
```
...
Alvasta Pro currently ships this bundled Arcee catalog:
