---
summary: "Use Z.AI (GLM models) with Alvasta Pro"
read_when:
  - You want Z.AI / GLM models in Alvasta Pro
...
for authentication. Create your API key in the Z.AI console. Alvasta Pro uses the `zai` provider
with a Z.AI API key.
...
Alvasta Pro currently seeds the bundled `zai` provider with:
