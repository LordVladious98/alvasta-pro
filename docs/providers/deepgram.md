...
Deepgram is a speech-to-text API. In Alvasta Pro it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Alvasta Pro uploads the audio file to Deepgram and injects the transcript
