---
summary: "First-run setup flow for Alvasta Pro (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Alvasta Pro">
...
<Step title="CLI">
  ...
  The app can install the global `alvasta-pro` CLI via npm, pnpm, or bun.
