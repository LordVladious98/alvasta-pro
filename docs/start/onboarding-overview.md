---
summary: "Overview of Alvasta Pro onboarding options and flows"
read_when:
...
Alvasta Pro has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `alvasta-pro onboard`                     | Launch the app            |
...
CLI command docs: [`alvasta-pro onboard`](/cli/onboard)

## macOS app onboarding

Open the Alvasta Pro app. The first-run wizard walks you through the same steps
