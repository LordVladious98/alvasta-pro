...
Alvasta Pro treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.alvasta-pro/settings/voicewake.json`

Shape:

```json
{ "triggers": ["alvasta-pro", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
