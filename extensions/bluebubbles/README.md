...
This package contains the **BlueBubbles external channel plugin** for Alvasta Pro.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `alvasta-pro/plugin-sdk` helpers.
