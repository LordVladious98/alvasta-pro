# @alvasta-pro/voice-call

Official Voice Call plugin for **Alvasta Pro**.
...
Docs: `https://docs.alvasta-pro.ai/plugins/voice-call`
Plugin system: `https://docs.alvasta-pro.ai/plugin`

## Install (local dev)

### Option A: install via Alvasta Pro (recommended)
...
```bash
PLUGIN_HOME=~/.alvasta-pro/extensions
mkdir -p "$PLUGIN_HOME"
...
- advanced webhook, streaming, and tunnel notes: `https://docs.alvasta-pro.ai/plugins/voice-call`
...
`https://docs.alvasta-pro.ai/plugins/voice-call#stale-call-reaper`

## TTS for calls

Voice Call uses the core `messages.tts` configuration for
streaming speech on calls. Override examples and provider caveats live here:
`https://docs.alvasta-pro.ai/plugins/voice-call#tts-for-calls`
