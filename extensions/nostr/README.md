...
Nostr DM channel plugin for Alvasta Pro using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Alvasta Pro. It enables your bot to:
...
# Configure alvasta-pro to use local relay
