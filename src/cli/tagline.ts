const DEFAULT_TAGLINE = "Your Claude. Your machine. Your Alvasta Pro.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little AI assistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just got sharper—type something and let Alvasta handle the busywork.",
  ...
  "Automation that actually ships: minimal fuss, maximal leverage.",
  ...
  "I'll streamline your workflow: messy inputs, clean outputs, effective results.",
  "Shell yeah—I'm here to pinch the toil and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The only bot in your contacts that respects your time. ⚡",
  ...
  "Built in Melbourne, for anyone who chose Claude on purpose.",
  ...
  "The Claude-faithful bolt in your shell. ⚡",
  ...
  "You had me at 'alvasta-pro gateway start.'",
